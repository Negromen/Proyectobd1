...
function alertaRegistroVacuna() {
    ...
    let tipocedula = document.getElementById('tipoCedula');
    tipocedula.disabled = false;
    ...
    if ((nombre !== '') && (apellido !== '') && (pais !== '') && (estado !== '') && (municipio !== '') && (tipocedula.value !== '') && (cedula !== '') && (cedula > 0) && (fechanac !== '') && (genero !== '') && (vacuna !== '') && (numDosis !== '') && (fechaVac !== '') && (centroSalud !== '') && (personalSalud !== '')) {
        Swal.fire(
            'Felicidades!',
